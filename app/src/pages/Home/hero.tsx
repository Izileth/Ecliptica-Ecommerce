...
import { DiscountCTA } from "~/src/components/common/Newleastter/leastter"
    ...
    <Container maxWidth="full" padding="sm" >
      ...
      <Section background="white" padding="sm" className="relative">
          <Carousel
              ...
              >
                  <span className="mb-2 font-serif text-sm tracking-widest">DESCUBRA</span>
      ...
      <Section id="categories-section" background="white" className="relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Title title="Categorias" subtitle="Desubra o Estilo Perfeito" color="dark" />
          <CategoriesGrid />
        </div>
      </Section>
      ...
      <Section background="white" className="relative">
            ...
            <FeaturedProducts title="Produtos em Destaque" subtitle="Selecionados com exclusividade para você" />
            </div>
      </Section>

      <Section background="white" className="relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <Title title="Depoimentos" subtitle="Ficou na Duvida na hora de Pedir?, Veja os Relatos dos Compradores" color="dark" />
      ...
      <div className="mx-auto max-w-7xl  px-4 sm:px-6 lg:px-8">
            <div className="mb-6">
            <Title title="Destaques e promoções" subtitle="Desubra o Estilo Perfeito" color="dark" />
            </div>
